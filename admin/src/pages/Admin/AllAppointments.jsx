...
const AllAppointments = () => {
  ...
  // Check if appointment is old (completed or cancelled)
  const isOldAppointment = (item) => {
  ...
  return (
    <div className='w-full max-w-6xl m-5 '>
      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] overflow-y-scroll'>
        <div className='hidden sm:grid grid-cols-[0.3fr_0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] grid-flow-col py-3 px-6 border-b'>
          <p></p> {/* Empty column for delete icon */}
          <p>#</p>
          <p>Patient</p>
          <p>Age</p>
          <p>Date & Time</p>
        ...
        {appointments.map((item, index) => (
          <div className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.3fr_0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50 group' key={index}>
            {/* Delete icon - appears on hover for old appointments */}
            <div className='flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity'>
              {isOldAppointment(item) && (
                <svg
                  onClick={() => {
