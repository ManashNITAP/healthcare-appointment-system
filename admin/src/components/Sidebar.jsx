...
import DoctorTools from './DoctorTools'
  ...
  return (
    <div className='min-h-screen bg-white border-r'>
      ...
      {dToken && <ul className='text-[#515151] mt-5'>
        ...
        <button 
          onClick={() => setShowDoctorTools(true)}
          className='flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer hover:bg-[#F2F3FF] w-full text-left'
        >
          <svg className='min-w-5 w-5 h-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
            <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z' />
          </svg>
          <p className='hidden md:block'>AI Tools</p>
        </button>
      </ul>}

      {/* Doctor Tools Modal */}
      {showDoctorTools && (
        <DoctorTools onClose={() => setShowDoctorTools(false)} />
      )}
    </div>
  )
}
